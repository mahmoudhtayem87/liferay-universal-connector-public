...
import ReviewMySqlConnection from "./ReviewMySqlConnection";
...
const MySqlConnectorWizard = forwardRef((props, ref) => {
	...
	return (
		<div>
			...
			>
				{active === 0 && (
					<div>
						<MySqlConnection handleSave={handleSaveConnection} ref={mySqlConnectionComponentRef}></MySqlConnection>
					</div>
				)}

				{active === 1 && (
					<div>
						<ReviewMySqlConnection config={config} handleSave={handleSaveSchema} ref={reviewMySqlConnectionComponentRef}></ReviewMySqlConnection>
					</div>
				)}
...
export default MySqlConnectorWizard;
